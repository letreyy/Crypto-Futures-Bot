...
export class MarketRegimeEngine {
    static classify(candles, indicators) {
        ...
        // Checking if ATR is expanding rapidly (e.g. current ATR > 1.5x previous ATR approximation or similar)
        // As a simple proxy, check if last candle's body is larger than 2x ATR
...
//# sourceMappingURL=regime-engine.js.map