...
export class PumpDetectorStrategy {
    name = 'Pump Detector';
    id = 'pump-detector';
    execute(ctx) {
...
export class MicroPullbackStrategy {
    name = 'Micro Pullback';
    id = 'micro-pullback';
    execute(ctx) {
        const { candles } = ctx;
...
export class DumpBounceStrategy {
    name = 'Dump Bounce';
    id = 'dump-bounce';
    execute(ctx) {
        const { indicators, candles } = ctx;
...
export class RangeBounceStrategy {
    name = 'Range Bounce';
    id = 'range-bounce';
    execute(ctx) {
        const { indicators, candles, liquidity } = ctx;
...
export class BreakoutFailureStrategy {
